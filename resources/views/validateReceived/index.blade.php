                                ...
                                <div class="card">
                                    <div class="card_body">
                                        <table class="table table-striped table-bordered table-sm ">
                                            ...
                                            <tbody>
                                                <form action="{{ route('admin.warehouse.validatereceived.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <tr>
                        ...
                        @foreach ($validateReceived as $validate)
                            <tr>
                                ...
                                <div class="text-center col">
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <tr>
                                                                                    <td class="text-center"
                                                                                        width="8px">
                                                                                        <select
                                                                                            class="form-select justify-center"
                                                                                    ...
                                                                                    <td class="text-center"
                                                                                        ...
                                                                                        <select class="form-select"
                                                                                            aria-label="Default select example"
                                                                                            name="through">
                                                                                            <option selected>Select SHIPPING
                                                                                                TRANSPORTATION</option>
                                                                                            @foreach ($deliveries as $delivery)
                                                                                                <option
                                                                                                    value="{{ $delivery->id_delivery }}">
                                                                                                    {{ $delivery->des_delivery }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </td>
                                    ...
                                    <td width="10px" align="center">
                                        <form action="{{ route('admin.requestorings.destroy', $validate) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            {{-- <button type="submit" class="btn btn-outline-danger btn-med">Remove</button> --}}
                                            <a type="submit" class="far fa-trash-alt btn btn-outline-danger btn-xs">
                                                Remove</a>
                                        </form>
                                    </td>
